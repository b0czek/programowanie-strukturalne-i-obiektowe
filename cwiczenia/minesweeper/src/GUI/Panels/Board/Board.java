...
import GUI.Panels.Board.VictoryParticles.SplitterSystem;
import GUI.Panels.Board.VictoryParticles.VictoryParticles;
    ...
    public Field createField(int i, int j) {
        return new Field(plansza.getField(i, j), new FieldActionCallback() {
            ...
            public void fieldRevealed(Field field) {
                ...
                int revealedFieldsCount = plansza.getRevealedFieldsCount();
                int totalFieldsCount = plansza.getM() * plansza.getN() - plansza.getSelectedDifficulty().getBombsCount();
                if(totalFieldsCount == revealedFieldsCount) {
                    // win
