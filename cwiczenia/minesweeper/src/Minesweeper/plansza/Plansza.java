...
public class Plansza {
    ...
    public Optional<Pole[]> revealField(Pole pole) {
        ...
        if(pole.getIsBomb()) {
            ...
            this.revealedFieldsCount = this.getM()*this.getN();
        ...
        this.gameFinished = this.isGameWon();
    ...
    public boolean isGameWon() {
        int revealedFieldsCount = getRevealedFieldsCount();
        int totalFieldsCount = getM() * getN() - getSelectedDifficulty().getBombsCount();
        return revealedFieldsCount == totalFieldsCount;
    }
